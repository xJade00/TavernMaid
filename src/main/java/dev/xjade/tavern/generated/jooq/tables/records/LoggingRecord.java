...
public class LoggingRecord extends UpdatableRecordImpl<LoggingRecord> implements Record5<Long, String, JSONB, String, LocalDateTime> {
    ...
    @Override
    public LoggingRecord values(Long value1, String value2, JSONB value3, String value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LoggingRecord(Long id, String category, JSONB variables, String description, LocalDateTime time) {
        super(Logging.LOGGING);
