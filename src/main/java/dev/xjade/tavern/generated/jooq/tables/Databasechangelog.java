...
import dev.xjade.tavern.generated.jooq.tables.records.DatabasechangelogRecord;
...
public class Databasechangelog extends TableImpl<DatabasechangelogRecord> {
  ...
  private Databasechangelog(
      Name alias, Table<DatabasechangelogRecord> aliased, Field<?>[] parameters) {
  ...
  public <O extends Record> Databasechangelog(
      Table<O> child, ForeignKey<O, DatabasechangelogRecord> key) {
